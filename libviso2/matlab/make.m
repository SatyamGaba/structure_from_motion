...
mex('visualOdometryMonoPreFeatureMex.cpp','../src/viso_mono.cpp','../src/viso.cpp','../src/matcher.cpp','../src/filter.cpp','../src/triangle.cpp','../src/matrix.cpp','-I../src','CXXFLAGS=-msse3 -fPIC');
mex('visualOdometryMonoPreMatchMex.cpp','../src/viso_mono.cpp','../src/viso.cpp','../src/matcher.cpp','../src/filter.cpp','../src/triangle.cpp','../src/matrix.cpp','-I../src','CXXFLAGS=-msse3 -fPIC');
