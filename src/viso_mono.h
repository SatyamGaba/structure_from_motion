...
private:
  ...
  void computeInliers(std::vector<Matcher::p_match> p_matched);
  ...
  // parameters
  parameters param;
  std::vector<Matcher::p_match> p_matched_inliers; // feature point matches (inliers)
};
